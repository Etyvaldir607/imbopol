...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			<?php if ($permiso_editarcosto) {
					 if ($rol_id <= 2) { ?>
							<a href="?/ingresos/editar_costo" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span><span class="hidden-xs"> Editar Costos</span></a>
			<?php } } ?>
