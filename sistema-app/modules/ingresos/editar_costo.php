...
<div class="panel-body">
	...
	<div class="row">
		<div class="col-sm-8 hidden-xs">
			<div class="text-label">Para editar el costo de los productos ingresados seleccionar el rango de fechas; para ello hacer clic en el siguiente botón: </div>
		</div>
...
<script>
	...
	function editar_costo(codigo) {
		bootbox.prompt({
			title: 'Está seguro que desea modificar el costo del producto?', 
			required: true,
			inputType: 'number',
