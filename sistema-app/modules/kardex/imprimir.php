...
$pdf->Cell($width_page*0.50, $height_cell * -3.5,  $codigo, 0, 0, 'L', 0, '', 1, true, 'T', 'M');
$pdf->Ln($padding-5);
...
$pdf->Cell($width_page * 0.50, $height_cell * 2.3, $precio, 0, 0, 'L', 0, '', 1, true, 'T', 'M');
$pdf->Ln($padding-5);
...
$body = '';
$body .= '<tr>';
$body .= '<th width="4%" align="center" style="border:1ps solid #aaa;" rowspan="2">#</th>';
$body .= '<th width="8%" align="center" style="border:1ps solid #aaa;" rowspan="2">FECHA</th>';
$body .= '<th width="15%" align="center" style="border:1ps solid #aaa;" rowspan="2">DESCRIPCION</th>';		
$body .= '<th width="21%" align="center" style="border:1ps solid #aaa;" colspan="3">ENTRADAS</th>';
$body .= '<th width="21%" align="center" style="border:1ps solid #aaa;" colspan="3">SALIDAS</th>';
$body .= '<th width="21%" align="center" style="border:1ps solid #aaa;" colspan="3">SALDOS</th>';
$body .= '<th width="10%" align="center" style="border:1ps solid #aaa;" rowspan="2">EMPLEADO</th>';
$body .= '</tr>';

$body .= '<tr>';
$body .= '<th width="7%" align="center" colspan="3" style="border:1ps solid #aaa;">CANTIDAD</th>';
$body .= '<th width="7%" align="center" colspan="3" style="border:1ps solid #aaa;">COSTO</th>';
$body .= '<th width="7%" align="center" colspan="3" style="border:1ps solid #aaa;">TOTAL</th>';
$body .= '<th width="7%" align="center" colspan="3" style="border:1ps solid #aaa;">CANTIDAD</th>';
$body .= '<th width="7%" align="center" colspan="3" style="border:1ps solid #aaa;">COSTO</th>';
$body .= '<th width="7%" align="center" colspan="3" style="border:1ps solid #aaa;">TOTAL</th>';
$body .= '<th width="7%" align="center" colspan="3" style="border:1ps solid #aaa;">CANTIDAD</th>';
...
foreach ($movimientos as $nro => $movimiento) { 
	if ($movimiento['tipo'] == 'i') {
		...
		$body .= '<td width="7%" align="rigth" style="background-color:#d0e9c6;">' . escape($movimiento['cantidad']) . '</td>';
		$body .= '<td width="7%" align="rigth" style="background-color:#d0e9c6;">' . escape($movimiento['monto']) . '</td>';
		$body .= '<td width="7%" align="rigth" style="background-color:#d0e9c6;">' . number_format(($movimiento['cantidad'] * $movimiento['monto']), 2, '.', '') . '</td>';
