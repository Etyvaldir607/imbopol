...
<div class="panel-heading" data-venta="<?= $id_venta; ?>" data-servidor="<?= ip_local . 'servidor/nota.php'; ?>">
	<h3 class="panel-title">
		...
		<strong>Detalle de nota de entrega</strong>
	</h3>
</div>
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<a href="?/notas/mostrar" class="btn btn-primary"><i class="glyphicon glyphicon-list-alt"></i><span class="hidden-xs hidden-sm hidden-md"> Notas de entrega</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
		...
		<div class="col-sm-10 col-sm-offset-1">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="glyphicon glyphicon-list"></i> Detalle de la nota de entrega</h3>
				</div>
				<div class="panel-body">
					<?php if ($detalles) { ?>
					...
					<div class="alert alert-danger">
						...
						<p>Esta nota de entrega no tiene detalle, es muy importante que todos los egresos cuenten con un detalle que especifique la operación realizada.</p>
					</div>
					<?php } ?>
				</div>
			</div>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="glyphicon glyphicon-log-out"></i> Información de la nota de entrega</h3>
				</div>
				<div class="panel-body">
	...
	$('[data-reimprimir]').on('click', function () {
		...
		$.ajax({
			...
			if (venta) {
				...
				$.notify({
					title: '<strong>Error!</strong>',
					message: '<div>Ocurrió un problema al obtener los datos de la nota de entrega.</div>'
				}, {
					type: 'danger'
				});
			}
