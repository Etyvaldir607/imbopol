...
<div class="panel-heading" data-formato="<?= strtoupper($formato_textual); ?>" data-mascara="<?= $formato_numeral; ?>" data-gestion="<?= date_decode($gestion_base, $_institution['formato']); ?>">
	<h3 class="panel-title">
		...
		<strong>Notas de entrega personales</strong>
	</h3>
</div>
<div class="panel-body">
	...
	<div class="row">
		<div class="col-sm-8 hidden-xs">
			<div class="text-label">Para realizar una nota de entrega hacer clic en el siguiente botón: </div>
		</div>
	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">Nota de entrega</td>
				...
				<td class="text-nowrap">
					<?php if ($permiso_ver) { ?>
					<a href="?/notas/ver/<?= $venta['id_egreso']; ?>" data-toggle="tooltip" data-title="Ver detalle de nota de entrega"><i class="glyphicon glyphicon-list-alt"></i></a>
					<?php } ?>
					<?php if ($permiso_eliminar) { ?>
					<a href="?/notas/eliminar/<?= $venta['id_egreso']; ?>" data-toggle="tooltip" data-title="Eliminar nota de entrega" data-eliminar="true"><span class="glyphicon glyphicon-trash"></span></a>
					<?php } ?>
				</td>
				<?php } ?>
			</tr>
	...
	<div class="alert alert-danger">
		...
		<p>No existen notas de entrega registradas en la base de datos.</p>
	</div>
	<?php } ?>
</div>
...
$(function () {	
	...
	$('[data-eliminar]').on('click', function (e) {
		...
		bootbox.confirm('Está seguro que desea eliminar la nota de entrega y todo su detalle?', function (result) {
			if(result){
				window.location = url;
			}
		});
