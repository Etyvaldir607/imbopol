        ...
        <div class="col-md-6">
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    ...
                    <?php } ?>
                    <form method="post" action="?/notas/guardar" class="form-horizontal">
                        ...
                        <div class="table-responsive margin-none">
                            <table id="ventas" class="table table-bordered table-condensed table-striped table-hover table-xs margin-none">
                                ...
                                <tr class="active">
                                    ...
                                    <th class="text-nowrap text-center width-collapse">UNIDAD</th>
                                    <th class="text-nowrap text-center width-collapse">PRECIO</th>
            ...
            <div class="panel panel-warning" data-servidor="<?= ip_local . name_project . '/factura.php'; ?>">
                <div class="panel-heading">
                    <h3 class="panel-title">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php if ($permiso_mostrar) { ?>
                        <div class="row">
                            <div class="col-xs-12 text-right">
                                <a href="?/manuales/mostrar" class="btn btn-warning"><i class="glyphicon glyphicon-list-alt"></i><span> Mis notas de entrega</span></a>
                            </div>
                        </div>
                        <hr>
                    <?php } ?>
                        ...
                        <table id="productos" class="table table-bordered table-condensed table-striped table-hover table-xs">
                            ...
                            <?php foreach ($productos as $nro => $producto) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap" data-barras="<?= $producto['id_producto']; ?>"><?= escape($producto['codigo_barras']); ?></td>
