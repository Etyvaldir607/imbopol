...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-9 text-right">
			...
			<a href="?/operaciones/proformas_imprimir/<?= $proforma['id_proforma']; ?>" class="btn btn-default" target="_blank"><i class="glyphicon glyphicon-file"></i><span class="hidden-xs"> Exportar</span></a>
			<?php } ?>
