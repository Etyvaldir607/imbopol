...
// Obtiene las ventas
$proformas = $db->select('i.*, a.almacen, a.principal, e.nombres, e.paterno, e.materno')->from('inv_proformas i')->join('inv_almacenes a', 'i.almacen_id = a.id_almacen', 'left')->join('sys_empleados e', 'i.empleado_id = e.id_empleado', 'left')->where('i.fecha_proforma >= ', $fecha_inicial)->where('i.fecha_proforma <= ', $fecha_final)->order_by('i.fecha_proforma desc, i.hora_proforma desc')->fetch();
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
            ...
            <?php if ($permiso_imprimir) { ?>
                <a href="?/operaciones/proformas_imprimir" class="btn btn-primary" target="_blank" data-imprimir="true"><span class="glyphicon glyphicon-file"></span><span class="hidden-xs"> Imprimir</span></a>
            <?php } ?>
		</div>
	</div>
	<hr>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">
					...
					<a href="?/operaciones/proformas_facturar/<?= $proforma['id_proforma']; ?>" data-toggle="tooltip" data-title="Convertir en facturar"><i class="glyphicon glyphicon-qrcode"></i></a>
					<?php } ?>
					<?php if ($permiso_ver) { ?>
