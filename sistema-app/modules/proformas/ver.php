		...
		<div class="col-sm-10 col-sm-offset-1">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="glyphicon glyphicon-list"></i> Detalle de la proforma</h3>
				</div>
				<div class="panel-body">
					<?php if ($detalles) { ?>
				...
				<div class="panel-body">
					<div class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-md-9">
								<p class="form-control-static"><?= escape(date_decode($proforma['fecha_proforma'], $_institution['formato'])); ?> <small class="text-success"><?= escape($proforma['hora_proforma']); ?></small></p>
							</div>
						</div>
						<div class="form-group">
