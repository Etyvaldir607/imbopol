			...
			<div class="modal-footer">
				<div class="row">
					<div class="col-xs-12 text-right">
						<a href="#" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span><span class="hidden-xs"> xCancelar</span></a>
						<button type="submit" id="enviar_subir" class="btn btn-primary"><i class="glyphicon glyphicon-ok"></i><span class="hidden-xs"> xGuardar</span></button>
