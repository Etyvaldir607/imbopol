...
// Genera la consulta
$select = "select p.id_producto, p.codigo, p.nombre, p.descripcion, p.color, p.nombre_factura, p.cantidad_minima, p.precio_actual, u.unidad, u.sigla, c.categoria";
	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
		...
		<tfoot>
			<tr class="active">
				...
				<?php } ?>
				<th class="text-nowrap text-middle" data-datafilter-filter="true">Total stock</th>
